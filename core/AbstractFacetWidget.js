...
AjaxSolr.AbstractFacetWidget = AjaxSolr.AbstractWidget.extend(
  ...
  initStore: function () {
    ...
    if (this['facet.field'] !== undefined) {
      ...
      this.manager.store[this.set].addByValue('facet.date', this.field);
      ...
      this.manager.store[this.set].addByValue('facet.range', this.field);
      parameters = parameters.concat([
        'facet.range.start',
        'facet.range.end',
        'facet.range.gap',
  ...
  getFacetCounts: function () {
    ...
    if (property !== undefined) {
      switch (this.manager.store[this.set].get('json.nl').val()) {
        case 'map':
